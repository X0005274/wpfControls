...
{
    /// <summary>
    /// 데이터 그리드(매트 테마) 컨트롤입니다. WinForms 폼의 도구 상자에서 드래그해 사용합니다.
    /// (WPF MatteDataGridControl 을 ElementHost로 감싼 래퍼입니다.)
    /// </summary>
    [ToolboxItem(true)]
    public class MatteDataGrid : WpfElementHostBase<com.example.Controls.Wpf.Data.MatteDataGridControl>
    {
        /// <summary>기본 크기를 지정하며 컨트롤을 만듭니다.</summary>
        public MatteDataGrid()
        {
