...
{
    /// <summary>
    /// 텍스트 입력 컨트롤입니다. WinForms 폼의 도구 상자에서 드래그해 사용합니다.
    /// (WPF ModernTextBoxControl 을 ElementHost로 감싼 래퍼입니다.)
    /// </summary>
    [ToolboxItem(true)]
    public class ModernTextBox : WpfElementHostBase<com.example.Controls.Wpf.Input.ModernTextBoxControl>
    {
